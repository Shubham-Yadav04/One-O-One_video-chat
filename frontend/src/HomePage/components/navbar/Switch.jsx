...
function Switch() {
  const {isDark,handleThemeToggle} = useUserData()
  return (
    <motion.button
      onClick={handleThemeToggle}
      aria-label="Toggle theme"
      className="flex items-center border-none bg-transparent cursor-pointer p-2 rounded-full transition-colors duration-300 focus:outline-none hover:bg-gray-100 dark:hover:bg-gray-800 gap-1"
      type="button"
